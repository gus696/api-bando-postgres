...
try:
    with gzip.GzipFile(fileobj=io.BytesIO(response_geometry.content)) as f:
        ...
        output_csv_path = "D:\\zukk\\Leroy\\geometry_data.csv"
        dfGeometry.to_csv(output_csv_path, index=False)
...
#             ALTER TABLE geometry_municipio
